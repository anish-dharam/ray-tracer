...
#world
    ...
    material_left_metal   = Metal(Color(0.8, 0.8, 0.8), 0) #reduced fuzz from 0.3 to 0
    material_right  = Metal(Color(0.8, 0.6, 0.2), 0.3) #reduced fuzz from 1 to 0.3
    material_cube   = Lambertian(Color(0.7, 0.91, 0.95))

    #anish example
    world.add(Sphere(Point3(0, 0, -1), 0.5, material_left_metal))
    ...
    world.add(Cube(Point3(4.0, -3.0, -5.5), 1.4, material_left_glass))
...
#camera
    cam = Camera(aspect_ratio=16.0 / 9.0, image_width=400, samples_per_pixel=500, max_depth=50, 
                 vfov=90, look_from=Point3(0, 0, 0), look_at=Point3(0, 0, -1), view_up=Vec3(0, 1, 0),
